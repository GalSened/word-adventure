...
export const CATEGORIES = {
    ...
    cosmetics: { id: 'cosmetics', name: 'אביזרים', icon: '✨', description: 'אביזרים מגניבים לדמות שלך' },
    boosters: { id: 'boosters', name: 'כוחות על', icon: '⚡', description: 'עזרה מיוחדת בכל משחק' },
    themes: { id: 'themes', name: 'צבעים למשחק', icon: '🎨', description: 'כל המשחק בצבעים אחרים' },
    consumables: { id: 'consumables', name: 'שיקויים וקסמים', icon: '🧪', description: 'משתמשים בהם פעם אחת — והם נעלמים!' },
};
...
export const STORE_ITEMS = {
    ...
    glasses: {
        ...
        category: 'cosmetics',
        rarity: 'common',
        description: 'משקפיים של חכמים אמיתיים!',
    ...
    extra_life: {
        ...
        category: 'boosters',
        rarity: 'epic',
        description: 'מתחילים כל שלב עם 4 לבבות!',
    ...
    potion_health: {
        ...
        rarity: 'common',
        description: 'מחזיר לב אחד במשחק!',
    ...
    skip_word: {
        ...
        category: 'consumables',
        rarity: 'rare',
        description: 'דילוג על מילה קשה אחת!',
