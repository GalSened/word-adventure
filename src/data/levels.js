...
export const LEVELS = [
    ...
    },
    {
        ...
        storyChapter: 'level_17',
        unlockRequirement: 16,
    },
    {
        id: 18,
        name: 'ממלכת מזג האוויר',
        ...
        storyChapter: 'level_18',
        unlockRequirement: 17,
    },
    {
        id: 19,
        name: 'אצטדיון הגיבורים',
    ...
    },
    {
        ...
        storyChapter: 'level_20',
        unlockRequirement: 19,
    },
    {
        id: 21,
        name: 'אליפות העולם של המילים',
        subtitle: 'The World Word Championship',
        categories: ['animals', 'food', 'family', 'colors', 'nature', 'body', 'actions', 'home', 'emotions', 'professions', 'school', 'transport', 'clothes', 'weather', 'sports', 'toys'],
        difficulty: 'expert',
        wordCount: 20,
        grammarEnabled: true,
        theme: {
